...
function API.add_test_items(inventory)
	-- for index, row in ipairs(ASSETS) do
	-- 	inventory:AddItem(row.asset)
	-- end

	for i = 1, 5 do
		inventory:AddItem(ASSETS[1].asset)
	end

	for i = 1, 5 do
		inventory:AddItem(ASSETS[2].asset)
	end
end
